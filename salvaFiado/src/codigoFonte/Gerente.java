...
public class Gerente extends Pessoa{
    ...
    public void visualizarProdutos() {
		for(Produto p: produto) {
			...
			System.out.println("PREÇO do Produto: "+p.getPreco_unitario());
    ...
    public void visualizarServicos() {
    	for(Servico s: servico) {
			System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
			System.out.println("ID do Serviço: "+s.getId_servico());
			System.out.println("NOME do Serviço: "+s.getNome_servico());
			System.out.println("PREÇO do Produto: "+s.getPreco_servico());
			System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
		}
	}
